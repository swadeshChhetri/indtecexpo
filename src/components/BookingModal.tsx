...
type ExhibitorFormProps = {
  onClose: () => void;
};

export default function ExhibitorForm({ onClose }: ExhibitorFormProps) {
  ...
  return (
    <section className="max-w-5xl mx-auto px-4 py-16 mt-96 relative">
      ...
      <button
        onClick={onClose}
        className="text-pink-500 hover:text-black mt-6 absolute top-8 right-9"
      > 
        <X size={55} />
      </button>
