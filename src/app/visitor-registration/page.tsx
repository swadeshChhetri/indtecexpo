...
import { Mail, Phone, Building2, Globe, User} from 'lucide-react'

export default function VisitorRegistrationForm() {
  const [visitorType, setVisitorType] = useState('Domestic Visitor')
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl mx-auto bg-white p-8 shadow-2xl rounded-3xl my-10 pt-36"
    >
      <h1 className="text-3xl font-bold text-center text-red-600 mb-1 uppercase">Visitor Registration / IMS 2025 Bengaluru</h1>
      <p className="text-center text-sm text-gray-500 mb-6">
        BIEC, Bengaluru 06 - 08 November 2025
        <br />
        <span className="text-blue-500 font-semibold">Get Ready for a Whirlwind of Inspiration</span>
      </p>

      {/* Visitor Type Selection */}
      <div className="flex justify-center gap-6 mb-6">
        {['Overseas Visitor', 'Domestic Visitor'].map(type => (
          <label key={type} className="flex items-center gap-2 text-gray-700">
            <input
              type="radio"
              value={type}
              checked={visitorType === type}
              onChange={() => setVisitorType(type)}
      ...
      <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <div className="flex items-center border rounded-xl px-3 py-2">
            ...
            <input type="email" className="w-full outline-none" required />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center border rounded-xl px-3 py-2">
            ...
            <input type="text" className="w-full outline-none" required />
          </div>
        </div>
        ...
        <div>
          <label className="text-sm font-semibold">Position / Designation *</label>
          <input type="text" className="w-full border rounded-xl px-3 py-2" required />
        </div>
        ...
        <div>
          ...
          <div className="flex items-center border rounded-xl px-3 py-2">
            ...
            <input type="tel" className="w-full outline-none" required />
          </div>
        </div>
        ...
        <div className="md:col-span-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-1">
            <input placeholder="Street" className="border rounded-xl px-3 py-2" />
            <input placeholder="City/Suburb" className="border rounded-xl px-3 py-2" />
            <input placeholder="State" className="border rounded-xl px-3 py-2" />
            <input placeholder="Zip/Post Code" className="border rounded-xl px-3 py-2" />
          </div>
        </div>
        ...
        <div className="md:col-span-2">
          <label className="text-sm font-semibold">Landline Phone Number</label>
          <input className="w-full border rounded-xl px-3 py-2" type="tel" />
        </div>

        <div className="md:col-span-2">
          <label className="text-sm font-semibold">I came to know about the fair through *</label>
          <select className="w-full border rounded-xl px-3 py-2" required>
            <option>Advertisement</option>
            <option>Email from Organiser</option>
            <option>Invitation by Exhibitors</option>
            <option>Phone call from organiser</option>
            <option>IMS 2025 website</option>
            <option>Social Media</option>
            <option>Invitation from India Representative</option>
            <option>Other</option>
          </select>
        </div>

        <fieldset className="md:col-span-2">
          <legend className="font-semibold mb-2">Products of interest (Please specify)</legend>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              "Technology Suppliers and Seekers",
              "Defence & Aviation Ministry",
              "Managers, Architects & Engineers",
              "Ministry of Defence & Aviation",
              "Heads of Service Departments",
              "Representatives from Defence Forces",
              "Key Personnel of Aviation and Defence Sectors",
              "Delegations from Government Departments",
              "Quality Control",
              "Heads of PSUS",
              "Trade Delegations",
              "Component Manufacturers",
              "Engineering Colleges",
              "Contractor/Subcontractor & Builders",
              "Trading & Marketing Companies",
              "Consultants",
              "Plant Heads",
              "Design Engineers",
              "Procurement Heads",
        ...
        <fieldset className="md:col-span-2">
          <legend className="font-semibold mb-2">Social Media Profile you Prefer for Communication from Us?</legend>
        ...
        <div className="md:col-span-2">
          <label className="flex items-center gap-2 text-sm">
            ...
            I allow the Organizer to use my data for sending information about the fairs being organized.
          </label>
        </div>
        ...
        <div className="md:col-span-2 flex justify-center">
          <button
            type="submit"
            className="bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-10 rounded-2xl shadow-md"
          >
            Submit
          </button>
        </div>
